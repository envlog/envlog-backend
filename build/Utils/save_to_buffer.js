...
exports.saveToBuffer = void 0;
var sensor_data_model_1 = __importDefault(require("../Models/sensor_data.model"));
var moment_1 = __importDefault(require("moment"));
var sensors = {};
var saveToBuffer = function (mqttObject) { return __awaiter(void 0, void 0, void 0, function () {
    var DevAddr, Unit, minifiedObject, Type, MCU_ID, finalObject, Type_1, MCU_ID_1, dataProperties, stringifiedProperties, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                DevAddr = mqttObject.DevAddr, Unit = mqttObject.Unit, minifiedObject = __rest(mqttObject, ["DevAddr", "Unit"]);
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, sensor_data_model_1.default.insertMany(sensors[Type].buffer)];
            case 2:
                _a.sent();
...
exports.saveToBuffer = saveToBuffer;
